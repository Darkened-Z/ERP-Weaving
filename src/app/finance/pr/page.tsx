      ...
      <div className="animate-in">
        <div className="flex flex-col sm:flex-row sm:items-baseline justify-between mb-3 gap-4">
          ...
          <ExcelExportButton
            ...
            filename="petty-cash-receipts"
            sheetName="PettyCashReceipts"
          />
        </div>
        ...
        <form id="pr-find-form" method="GET" action={BASE} className="hidden"></form>
        ...
        <div className="border border-black p-4 mb-3">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            ...
            <div className="flex gap-2 no-print flex-wrap">
              ...
              {showForm && (
                <button type="submit" form="pr-save-form" className="btn btn-sm">
                  Save
                </button>
              )}
              {formVoucher?.id ? (
          ...
          {showForm ? (
            <form id="pr-save-form" action={saveVoucher}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-3 gap-y-3 gform">
                ...
                <div className="lg:col-span-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <button form="pr-find-form" type="submit" className="btn btn-outline btn-sm">
                      Find
                    </button>
                  </div>
                </div>
