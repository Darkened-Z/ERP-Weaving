...
export default async function CashPaymentPage({
  ...
  const pat = findFilter ? `%${escLike(findFilter)}%` : "";
  const listWhere = and(
        ...
        <div className="border border-black p-4 mb-3">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            ...
            <div className="flex gap-2 no-print flex-wrap">
              ...
              <button type="submit" form="cp-save-form" className="btn btn-sm">
                Save
              </button>
              {formVoucher?.id ? (
                <a
          ...
          <form id="cp-save-form" action={saveVoucher}>
        ...
        <div className="border border-black">
          <div className="px-4 py-3 border-b-2 border-black flex items-center justify-between gap-2 flex-wrap">
            ...
            <div className="flex gap-2 no-print">
              ...
              />
              <button form="cp-find-form" type="submit" className="btn btn-outline btn-sm">
                Find
              </button>
              {findFilter && (
                <a href={BASE} className="btn btn-outline btn-sm">
