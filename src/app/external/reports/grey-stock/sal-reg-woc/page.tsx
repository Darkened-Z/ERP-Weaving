...
const TITLE = "SALES REGISTER (WITHOUT CONTRACT)";

export default async function SalRegWocPage({
  searchParams,
}: {
  ...
  const conditions = [
    ...
    or(
      isNull(schema.extGodownStock.salContNo),
      isNull(schema.extGodownStock.contNo)
    )!,
    ...buildTextFilters(f),
  ];
