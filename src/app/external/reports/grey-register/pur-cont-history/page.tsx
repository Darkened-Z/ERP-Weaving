...
export default async function PurContHistoryPage({
  ...
  let contract: typeof schema.extGreyPurContract.$inferSelect | null = null;
  let deliveries: (typeof schema.extGreyPurContractDelivery.$inferSelect)[] = [];

  if (contNo) {
    const rows = await db
      .select()
      .from(schema.extGreyPurContract)
      .where(eq(schema.extGreyPurContract.contractNo, contNo))
      .limit(1);
    ...
    if (contract) {
      deliveries = await db
        ...
        .where(eq(schema.extGreyPurContractDelivery.contractId, contract.id));
    }
  }
    ...
    <>
      ...
      <div className="rpt-wrap">
        <div className="rpt-toolbar no-print">
          <div className="rpt-toolbar-title">PURCHASE CONTRACT HISTORY</div>
        ...
        <div className="rpt-page">
          ...
          <div className="doc-title">PURCHASE CONTRACT HISTORY</div>
              ...
              <div className="info-grid">
                ...
                <div className="info-row" style={{ gridColumn: "1 / -1" }}>
                  ...
                  <span className="info-value">
                    {contract.broker ?? "-"}
                    {contract.brokagPercentage != null ? ` (${fmt2(contract.brokagPercentage)}%)` : ""}
                  </span>
                </div>
                <div className="info-row">
