...
export default async function GreySalesContractPage({
  ...
  const greyOpts = greyList.map((g) => ({ value: g.code, label: g.width ? `${g.code} — ${g.width}" ${g.description}` : `${g.code} — ${g.description}`, desc: g.description }));
          ...
          <div className="border border-black p-4">
            <div className="flex items-center justify-between mb-4 pb-2 border-b border-black">
              ...
              <div className="flex gap-2">
                ...
                {formItem && (
                  <a
                    href={`/external/contracts/grey-sales/${formItem.id}/print`}
                    target="_blank"
