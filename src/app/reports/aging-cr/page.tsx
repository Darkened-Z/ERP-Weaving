...
export default async function AgingCreditorsPage({
  searchParams,
}: {
  ...
  return (
    <Shell active="fin-aging-cr">
      <div className="animate-in">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-baseline justify-between gap-4">
          <div>
            <h1 className="page-title">Creditors Aging</h1>
            <p className="text-[13px] text-[var(--muted)] mt-2">
              As of {asOf} · {rows.length} creditors
            </p>
          </div>
